...
from .serializers import (
    UserCreateSerializer, CustomAuthTokenSerializer,
    UserSerializer, RequestSerializer, PasswordResetSerializer,
    UserManageSerializer, EmptySerializer
)
...
class UserView(GenericAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        user = request.user
        user.delete()
        return Response({"message" : f"Successfully deleted USER - {kwargs['id']}"}, status=HTTP_204_NO_CONTENT)
